...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *name = [_foodList objectAtIndex:indexPath.row];
    //MenuItem *food = [[MenuItem alloc] initWithName:name andURL:nil];
...
- (void) refreshData {
    _foodList = [(NSArray*)[[PFInstallation currentInstallation] objectForKey:@"favorites"] mutableCopy];
}
