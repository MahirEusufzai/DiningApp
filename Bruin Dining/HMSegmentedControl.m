...
#define segmentImageTextPadding 1
#define iconSize 10
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
		...
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            UIImage *icon = iconImage;
            CGFloat imageWidth = iconSize;//icon.size.width;
            CGFloat imageHeight =iconSize;// icon.size.height;
            ...
            CGFloat imageXOffset = self.segmentEdgeInset.left+1; // Start with edge inset
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed)
            ...
            CGRect imageRect = CGRectMake(imageXOffset+2, yOffset+3, imageWidth, imageHeight);
